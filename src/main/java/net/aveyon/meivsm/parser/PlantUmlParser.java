...
public class PlantUmlParser extends Parser {
	...
	public static final int
		...
		START_END_STATE=9, COLON=10, COMMA=11, ASSIGN_OP=12, OP_EQUAL=13, OP_LT=14, 
		OP_LTE=15, OP_GT=16, OP_GTE=17, PLUS=18, MINUS=19, DIVIDE=20, MULT=21, 
		BRACKET_OPEN=22, BRACKET_CLOSE=23, CLOSURE_OPEN=24, CLOSURE_CLOSE=25, 
		CLOSURE=26, AND=27, OR=28, STRING=29, INTEGER=30, UINTEGER=31, ADDRESS=32, 
		BOOLEAN=33, BYTE_ARRAY=34, TRUE=35, FALSE=36, ETHER=37, WEI=38, DAYS=39, 
		SOL_GLOBAL_SENDER=40, SOL_GLOBAL_VALUE=41, SOL_GLOBAL_DATE=42, SOL_GLOBAL_DATE2=43, 
		ARROW=44, LONG_ARROW=45, LONG_LONG_ARROW=46, LONG_ARROW_UP=47, LONG_ARROW_DOWN=48, 
		LONG_ARROW_LEFT=49, LONG_ARROW_RIGHT=50, ACTIVITY=51, RETURN=52, EMIT=53, 
		TRANSFER=54, TO=55, SKINPARAM=56, NUMBER=57, HEX_COLOR=58, IDENTIFIER=59, 
		OBJECT_ACCESS=60, STRING_VALUE=61, VALUE=62, WS=63;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'pay*'", "'sent from'", "'@startuml'", "'@enduml'", "'[*]'", "':'", 
			"','", "'='", "'=='", "'<'", "'<='", "'>'", "'>='", "'+'", "'-'", "'/'", 
			"'*'", "'['", "']'", "'('", "')'", "'()'", "'&'", "'|'", "'string'", 
			"'int'", "'uint'", "'address'", "'bool'", "'bytes'", "'true'", "'false'", 
			"'ether'", "'wei'", "'days'", null, "'msg.value'", "'now'", "'block.timestamp'", 
			"'->'", "'-->'", "'--->'", "'-u->'", "'-d->'", "'-l->'", "'-r->'", null, 
			"'return'", "'emit'", "'transfer'", "'to'", "'skinparam'"
		};
	}
	private static final String[] _LITERAL_NAMES = makeLiteralNames();
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, "START_UML", "END_UML", "START_END_STATE", 
			...
			"RETURN", "EMIT", "TRANSFER", "TO", "SKINPARAM", "NUMBER", "HEX_COLOR", 
			"IDENTIFIER", "OBJECT_ACCESS", "STRING_VALUE", "VALUE", "WS"
		};
	}
